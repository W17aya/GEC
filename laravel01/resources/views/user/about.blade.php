    ...
    <div class="card">
        ...
        <li class="mb-2">
            ...
            data-toggle="modal" data-target="#DeleteModal">Hapus</button>
             ...
             <!-- SLIDER -->
<header id="main-slide"> 7 <div id="mySlide" class="carousel slide carousel-fade" data-ride="carousel"> 8 <ol class="carousel-indicators"> 9 <li data-target="#mySlide" data-slide-to="0" class="active"></li>
